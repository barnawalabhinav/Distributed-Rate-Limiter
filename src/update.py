...
def update_constants():
    ...
    request_limit = data.get('REQ_LIMIT')
    request_expiry_time = data.get('REQ_EXPIRY_TIME')
    ...
    with open('constants.py', 'r+') as file:
        ...
        for line in lines:
            ...
            elif 'REQ_LIMIT' in line:
                file.write(f"REQ_LIMIT: Final[int] = {request_limit}\n")
            elif 'REQ_EXPIRY_TIME' in line:
                file.write(
                    f"REQ_EXPIRY_TIME: Final[int] = {request_expiry_time}\n")
            else:
                file.write(line)
